...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("║   Semana 8 - Interfaces, Polimorfismo y GUI      ║");
        System.out.println("╚══════════════════════════════════════════════════╝");
        ...
        // ── Semana 8: gestión de nuevas entidades (Registrable) vía GUI ─────
        System.out.println("\nAbriendo gestión de entidades (guías, vehículos, colaboradores)...");
        EntidadesGUI entidadesGUI = new EntidadesGUI();
